...
el.value = ""; // Devuelve el valor que tiene un elemento, para checkbox, input y cajones de usuarios. Más usados.
...
el.hidden = true; // Devuelve si el elemento esta oculto. Casi no se usa.
